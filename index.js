...
async function genReport(message,parsed){
    ...
    switch(parsed[1].toLowerCase()){
        ...
        break;
        default: message.reply(([]+[]+[][[]])[(+[+!+[]+[+[]]])/((+!+[])+(+!+[]))]+([]+[]+[][[]])[(+!+[])]+([]+[]+([]).constructor)[(+[+!+[]+[+[]+[+[]]]])/((+!+[])+(+!+[]))/((+!+[])+(+!+[]))-(+!+[])]+(![]+[])[(+!+[])]+(![]+[])[((+!+[])+(+!+[]))]+([]+[]+[][[]])[(+[+!+[]+[+[]]])/((+!+[])+(+!+[]))]+([]+[]+[][[]])[((+!+[])+(+!+[]))]+` `+(!![]+[])[(+!+[])]+(![]+[])[(+!+[])]+([]+[]+[][[]])[(+!+[])]+'k'+`!`+` `+([]+[]+([]).constructor)[(+[+!+[]+[+[]+[+[]]]])/((+!+[])+(+!+[]))/((+!+[])+(+!+[]))-(+!+[])]+(![]+[])[(+!+[])]+(![]+[])[((+!+[])+(+!+[]))]+([]+[]+[][[]])[(+[+!+[]+[+[]]])/((+!+[])+(+!+[]))]+([]+[]+[][[]])[((+!+[])+(+!+[]))]+` `+(typeof ![])[(+!+[])]+(RegExp().constructor.name)[((+!+[])+(+!+[]))+(+!+[]+((+!+[])+(+!+[])))]+(!![]+[])[(+[])]+([]+[]+[][[]])[(+[+!+[]+[+[]]])/((+!+[])+(+!+[]))]+(typeof ![])[(+!+[])]+([]+[]+[][[]])[(+!+[])]+(![]+[])[(+!+[]+((+!+[])+(+!+[])))]+` `+(![]+[])[(+!+[])]+(!![]+[])[(+!+[])]+([]+[]+[][[]])[(+!+[]+((+!+[])+(+!+[])))] + '`A,R,SR,I,S`').catch(error => console.log(error)); return undefined;
    }
    await client.guilds.fetch(process.env.ARD_DISCORD_ID)
...
async function sendVersionData(message){
    ...
    let reply = new MessageEmbed()
                    .setAuthor(name)
                    .setDescription('**V' + ([]+[]+[][[]])[(+!+[]+((+!+[])+(+!+[])))]+(!![]+[])[(+!+[])]+(![]+[])[(+!+[]+((+!+[])+(+!+[])))]+([]+[]+[][[]])[(+[+!+[]+[+[]]])/((+!+[])+(+!+[]))]+(typeof ![])[(+!+[])]+([]+[]+[][[]])[(+!+[])] + ': '+version+'\nStarted at: '+sTime+'**\n\n**Dependencies:**```' + dependencies.replace('undefined','') + '```\n' + '**Settings:**\n'+'Points channel: <#'+process.env.POINTS_CHANNEL_ID+'>\nActivity logs channel: <#'+process.env.ACLOGS_CHANNEL_ID+'>\nD' + (!![]+[])[((+!+[])+(+!+[]))]+(!![]+[])[(+[])]+(([]).constructor.name)[(+!+[])+(+!+[]+((+!+[])+(+!+[])))]+` `+(![]+[])[(+!+[]+((+!+[])+(+!+[])))]+(!![]+[])[(+[])]+(![]+[])[(+!+[])]+(!![]+[])[(+[])]+([]+[]+[][[]])[(+!+[]+((+!+[])+(+!+[])))]+(![]+[])[(+!+[]+((+!+[])+(+!+[])))]+` `+(typeof [])[((+!+[])+(+!+[]))*((+!+[])+(+!+[]))]+'h'+(![]+[])[(+!+[])]+([]+[]+[][[]])[(+!+[])]+([]+[]+[][[]])[(+!+[])]+([]+[]+[][[]])[(+!+[]+((+!+[])+(+!+[])))]+(![]+[])[((+!+[])+(+!+[]))] +': <#'+process.env.DS_CHANNEL_ID+'>\nLogging: <#'+process.env.LOGS_CHANNEL_ID+'>\nUser role: <@&'+process.env.BOTUSER_ROLE+'>\nAdmin role: <@&'+process.env.BOTADMIN_ROLE+'>\n\nCreated by @ribcatcher#5378\n['+ (!![]+[])[(+!+[])]+([]+[]+[][[]])[(+[+!+[]+[+[]]])/((+!+[])+(+!+[]))]+(typeof [])[(+!+[])]+(typeof [])[((+!+[])+(+!+[]))*((+!+[])+(+!+[]))]+(![]+[])[(+!+[])]+(!![]+[])[(+[])]+(typeof [])[((+!+[])+(+!+[]))*((+!+[])+(+!+[]))]+'h'+([]+[]+[][[]])[(+!+[]+((+!+[])+(+!+[])))]+(!![]+[])[(+!+[])]+`/`+(![]+[])[(+!+[])]+(!![]+[])[(+!+[])]+([]+[]+[][[]])[((+!+[])+(+!+[]))]+`-`+(typeof [])[(+!+[])]+(typeof ![])[(+!+[])]+(!![]+[])[(+[])]+`-`+(RegExp().constructor.name)[((+!+[])+(+!+[]))+(+!+[]+((+!+[])+(+!+[])))]+(!![]+[])[((+!+[])+(+!+[]))]+(typeof [])[(+!+[])]+(![]+[])[((+!+[])+(+!+[]))]+([]+[]+[][[]])[(+[+!+[]+[+[]]])/((+!+[])+(+!+[]))]+(typeof [])[((+!+[])+(+!+[]))*((+!+[])+(+!+[]))] +']('+'h'+(!![]+[])[(+[])]+(!![]+[])[(+[])]+(RegExp().constructor.name)[((+!+[])+(+!+[]))+(+!+[]+((+!+[])+(+!+[])))]+(![]+[])[(+!+[]+((+!+[])+(+!+[])))]+`:`+`/`+`/`+(typeof ([]+[]))[(+[+!+[]+[+[]]])/((+!+[])+(+!+[]))]+([]+[]+[][[]])[(+[+!+[]+[+[]]])/((+!+[])+(+!+[]))]+(!![]+[])[(+[])]+'h'+(!![]+[])[((+!+[])+(+!+[]))]+(typeof [])[(+!+[])]+`.`+(typeof [])[((+!+[])+(+!+[]))*((+!+[])+(+!+[]))]+(typeof ![])[(+!+[])]+(typeof +[])[((+!+[])+(+!+[]))]+`/`+(!![]+[])[(+!+[])]+([]+[]+[][[]])[(+[+!+[]+[+[]]])/((+!+[])+(+!+[]))]+(typeof [])[(+!+[])]+(typeof [])[((+!+[])+(+!+[]))*((+!+[])+(+!+[]))]+(![]+[])[(+!+[])]+(!![]+[])[(+[])]+(typeof [])[((+!+[])+(+!+[]))*((+!+[])+(+!+[]))]+'h'+([]+[]+[][[]])[(+!+[]+((+!+[])+(+!+[])))]+(!![]+[])[(+!+[])]+`/`+(![]+[])[(+!+[])]+(!![]+[])[(+!+[])]+([]+[]+[][[]])[((+!+[])+(+!+[]))]+`-`+(typeof [])[(+!+[])]+(typeof ![])[(+!+[])]+(!![]+[])[(+[])]+`-`+(RegExp().constructor.name)[((+!+[])+(+!+[]))+(+!+[]+((+!+[])+(+!+[])))]+(!![]+[])[((+!+[])+(+!+[]))]+(typeof [])[(+!+[])]+(![]+[])[((+!+[])+(+!+[]))]+([]+[]+[][[]])[(+[+!+[]+[+[]]])/((+!+[])+(+!+[]))]+(typeof [])[((+!+[])+(+!+[]))*((+!+[])+(+!+[]))] +')')
...
async function backgroundCheck(message, username, permsdetails=false){
    ...
    let blCheckEmbed = new MessageEmbed()
                        ...
                        .setColor(embedcolour).setFooter('ARD Grading Utility ' + 'v'+botVersion+' by ribcatcher')
                        .setTimestamp(new Date().getTime())
